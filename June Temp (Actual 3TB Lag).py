...
for iteration in range(1, 31):
    ...
    while model_run_time != day_end:
        ...
        exog_train = df_cli.loc[train_start_date:train_end_date][['temp']]
        exog_test = df_cli.loc[train_end_date + pd.Timedelta(minutes=15):test_end_date][['temp']]
